...
<body class="non_background">
	...
	<form id="Join-Form" method="post"
		action="./inputPro.do" name="userinput" onSubmit="return checkIt()">
		...
		<div class="Loginbody form-group">
			...
			<div class="row categoryFrm">
				...
				<div class="col-xs-10">
					...
					</label> <label class="checkbox-inline"> <input type="checkbox" value="토익스피킹">토익스피킹
					</label> <label class="checkbox-inline"> <input type="checkbox" value="회화">회화
					</label>
				</div>
			</div>
			...
			<div class="row categoryFrm">
				...
				<div class="col-xs-10">
					<label class="checkbox-inline"> <input type="checkbox" name="scategorycode" value="일본어">일본어
					</label><label class="checkbox-inline"> <input type="checkbox" value="중국어">중국어
					</label><label class="checkbox-inline"> <input type="checkbox" value="프랑스어">프랑스어
					</label>
				</div>
			</div>
			...
			<div class="row categoryFrm">
				...
				<div class="col-xs-10">
					<label class="checkbox-inline"> <input type="checkbox" value="인적성">인적성
					</label><label class="checkbox-inline"> <input type="checkbox" value="면접">면접
					</label><label class="checkbox-inline"> <input type="checkbox" value="자소서">자소서
					</label><label class="checkbox-inline"> <input type="checkbox" value="기타">기타
					</label>
				</div>
			</div>
