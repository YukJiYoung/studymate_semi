	...
	<div class="container" style="margin-top:100px; min-height:600px;">
		...
		<div class="tab-content">
			...
			<div id="question" class="tab-pane fade">
				...
				<form>
					<div class="form-group">
						<label for="name">이름:</label> <input type="text" class="form-control" id="name" style="width: 30%">
					</div>
					<div class="form-group">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 text-center">
					<h1><a href="<c:url value="/index.do" />">StudyMate</a></h1>
				</div>
				<div class="col-sm-8 footer_content text-center">
					<ul class="nav navbar-nav footer_menu text-center">
						<li><a href="<c:url value="/customerboard/MVC/list.do" />">고객지원</a></li>
						<li><a href="<c:url value="/notice/content.do?noticeNum=1&pageNum=1" />">이용안내</a></li>
